    ...
    public function migrar(Request $request)
    {
        ...
        DB::insert("
            ...
            from ".$request -> db.".".$encuesta -> nombre_tabla." a
             ...
             LEFT JOIN parametrica prvs1 on prvs1.tabla = 'RANGO_VS1' and prvs1.codigo =SUBSTR(a.questionnaire,160,1)
             LEFT JOIN parametrica pgen on pgen.tabla = 'genero' and pgen.codigo = SUBSTR(a.questionnaire,161,1)
             LEFT JOIN parametrica nvs1 on nvs1.tabla = 'NSE_VS1' and nvs1.codigo = SUBSTR(a.questionnaire,162,1)
        ...
        insert into encuesta_detalle2
            ...
            from ".$request -> db.".".$encuesta -> nombre_tabla." a
            LEFT JOIN parametrica rvs on rvs.tabla = 'RESULTADO_VS1' and LTRIM(RTRIM(rvs.codigo)) = LTRIM(RTRIM(SUBSTR(a.questionnaire,2219,2)))
            ");
