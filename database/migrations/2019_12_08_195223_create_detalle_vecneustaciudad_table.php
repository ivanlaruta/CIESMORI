    ...
    public function up()
    {
      DB::statement("
          create view v_detalle_encuestas_ciudad as
              select d.id_encuesta,c.id,d.ciudad,de.nombre departamento,e.total_encuesta total_encuesta,count(d.id_encuesta) cantidad, (count(d.id_encuesta)*100/cc.meta) porcentaje
              ...
              group by id_encuesta,c.id,ciudad,e.total_encuesta ,de.nombre, cc.meta
      ");
