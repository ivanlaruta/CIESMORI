...
class CreateVdetalleMultimediaTable extends Migration
{
    ...
    public function up()
    {
      DB::statement("
          ...
          SELECT d.ci_enc,d.id_encuesta,e.nombre,d.ciudad, d.nomb_enc, a.tipo, substr(d.id_auxiliar,1,26) as id_auxiliar, substr(a.nombre_archivo,1,26) as nombre_archivo
