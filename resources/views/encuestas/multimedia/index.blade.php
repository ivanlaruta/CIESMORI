        ...
        <div class="x_panel">
          ...
          <div class="x_content">
            ...
            <div class="detalle">
              ...
              <div class="contenido_multimedia  table-responsive"></div>
...
var contenido_multimedia = $(".contenido_multimedia");
...
var ejecuta_ajax = function(encuesta,campos){
  $.ajax({
    ...
    cache: false,
    dataType: "html",
    url: "{{ route('encuesta.contenido_multimedia')}}",
    data: {
    ...
    success: function(dataResult)
    {
      contenido_multimedia.empty().html(dataResult);
      aplicardatatable();
    }
  });
};
