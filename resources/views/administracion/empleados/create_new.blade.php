          ...
          <form method="get" action="{{  route('administracion.empleados.create') }}" class="form-horizontal form-label-left" id="empleados_form" >
            {{ csrf_field() }}
              ...
              <div class="form-group">
                ...
                <div class="col-md-4 col-sm-4 col-xs-12">
                  <select class="form-control col-md-12 col-xs-12 select_nivel_educacion" data-width="100%" id="cod_nivel_educacion" name="cod_nivel_educacion" required="required">
                    <option></option>
              ...
              <div class="form-group">
                ...
                <div class="col-md-4 col-sm-4 col-xs-12">
                  <select class="form-control col-md-7 col-xs-12 select_tipo_estudio" data-width="100%" id="cod_tipo_estudio" name="cod_tipo_estudio" required="required">
                    <option></option>
              ...
              <div class="form-group">
                ...
                <div class="col-md-3 col-sm-3 col-xs-12">
                  <select class="form-control col-md-7 col-xs-12 select_horario_disponible" data-width="100%" id="cod_horario_disponible" name="cod_horario_disponible" required="required">
                    <option></option>
